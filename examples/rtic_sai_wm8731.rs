...
mod app {
    ...
    fn init(cx: init::Context) -> (Shared, Local) {
        ...
        let (Some(sai1_tx), Some(sai1_rx)) = sai1.split(&hal::sai::SaiConfig::i2s(hal::sai::bclk_div(8)))
        else {
        ...
        let mut wm8731: MyWm8731 = Wm8731::new(I2CInterface::new(i2c, 0x1A));
        {
